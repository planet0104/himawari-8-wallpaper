...
*/
pub fn combine_4x4(year:i32, month:u32, day:u32, hour:u32, ten_minute:u32) -> Result<ImageBuffer<Rgb<u8>, Vec<u8>>, Box<std::error::Error>>{
...
//合成2x2的图
#[allow(dead_code)]
pub fn combine_2x2(year:i32, month:u32, day:u32, hour:u32, ten_minute:u32) -> Result<ImageBuffer<Rgb<u8>, Vec<u8>>, Box<std::error::Error>>{

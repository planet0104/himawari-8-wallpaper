...
pub fn set_half<C>(screen_width: i32, screen_height:i32, callback: C) -> Result<(), Box<std::error::Error>>  where C:Fn(i32, i32)+'static {
    ...
    if screen_height<screen_width{
        ...
        let image = image::imageops::resize(&image, screen_width as u32, screen_width as u32, image::FilterType::Gaussian);
        ...
        let mut image = image::imageops::resize(&image, screen_height as u32, screen_height as u32, image::FilterType::Nearest);
